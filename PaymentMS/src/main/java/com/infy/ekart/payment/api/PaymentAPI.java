...
public class PaymentAPI {
	...
	public ResponseEntity<String> payForOrder(
		...
		int orderId = transactionDTO.getOrder().getOrderId();
		OrderDTO order = template.getForEntity("http://CustomerMS/customerorder-api/order/"+orderId, OrderDTO.class).getBody();
